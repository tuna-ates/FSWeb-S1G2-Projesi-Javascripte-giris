...
*/
   let degisken1="1999";
   let degisken2=Number(degisken1);
...
function kopeginYasi(insanYası) {
  let kopekYasiHesaplama=insanYası*7;
  return kopekYasiHesaplama;
}
...
function oyun(oyuncu, bilgisayar) {
   ...
   if((oyuncu==tas&&bilgisayar==kağıt)||(oyuncu==kağıt&&bilgisayar==makas)||(oyuncu==makas&&bilgisayar==tas)){
    return "Kaybettin!";
   }
...
function bilgisayarinSecimi() {
  let pcSecimi;
  pcSecimi=Math.floor(Math.random()*3);
